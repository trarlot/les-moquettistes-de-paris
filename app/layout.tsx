        ...
        <html lang="fr">
            <body
                ...
                <AOSProvider>
                    ...
                    <Link
                        href="/contact"
                        className="fixed bottom-6 right-6 z-50 bg-red-700 hover:bg-red-800 text-white px-6 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300  flex items-center gap-2 text-base sm:text-lg font-semibold fade-up-animation">
